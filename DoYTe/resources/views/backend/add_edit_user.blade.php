	...
	<div class="panel panel-primary">
		...
		<input type="hidden" name="_token" value="{{ csrf_token() }}">
			...
			<div class="row" style="margin-top:5px;">
				...
				<div class="col-md-10">
					<input type="password" name="password" class="form-control"  (isset($arr->email)) placeholder="Không đổi password thì không nhập thông tin vào ô textbox này" @else required @endif>
				</div>
			</div>
			<!-- end rows -->
			<!-- rows -->
