...
@section('do-du-lieu-vao-template')
 <div class="product-detail" itemscope itemtype="http://schema.org/Product">
          ...
          <meta itemprop="image" content="frontend/public/frontend/images/msc.jpg?v=1469340617533">
          <meta itemprop="shop-currency" content="VND">
          <div class="top">
            <div class="row">
              <?php
                $productDT =  DB::table("tbl_product")->where("pk_product_id","=",$id)->first();
               
               ?>
              <div class="col-xs-12 col-md-6 product-image">
                <div class="featured-image"> <img src="{{ asset($productDT->c_img) }}" class="img-responsive" id="large-image" itemprop="image" 
                  title="{{ $productDT->c_name }}" 
            /> </div>
              </div>
              <div class="col-xs-12 col-md-6 info">
                <h1 itemprop="name">{{ $productDT->c_name }}</h1>
                <p class="sku">Mã sản phẩm:&nbsp; <span></span></p>
                <p class="vendor">Nhà sản xuất:&nbsp; <span>....</span></p>
                <p itemprop="price" class="price-box product-price-box"> <span class="special-price"> <span class="price product-price"> {{ $productDT->c_price }}₫ </span> </span> </p>
                <p class="desc rte"> {{ $productDT->c_description }}</p>
          ...
          <div class="middle">
            ...
            <div class="tab-container"> 
              ...
              <div id="tab1" class="content-tabs">
                <div class="rte">
                  <p style="text-align: justify;">{{ $productDT->c_content }}</p>
